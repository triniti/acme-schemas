...
import TrinitiDamAssetScheduledV1Mixin from '@triniti/schemas/triniti/dam/mixin/asset-scheduled/AssetScheduledV1Mixin';

export default class AssetScheduledV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:acme:dam:event:asset-scheduled:1-0-0', AssetScheduledV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(AssetScheduledV1);
MessageResolver.register('acme:dam:event:asset-scheduled', AssetScheduledV1);
Object.freeze(AssetScheduledV1);
Object.freeze(AssetScheduledV1.prototype);
