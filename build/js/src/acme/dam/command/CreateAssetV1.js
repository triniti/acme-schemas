...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:dam:command:create-asset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:dam:command:create-asset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:dam:command:create-asset:v1';
