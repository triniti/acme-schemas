...
export default class AssetV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:acme:dam:node:asset:1-0-0', AssetV1,
      [
...
GdbotsNcrNodeV1Trait(AssetV1);
TrinitiDamAssetV1Trait(AssetV1);
MessageResolver.register('acme:dam:node:asset', AssetV1);
Object.freeze(AssetV1);
Object.freeze(AssetV1.prototype);
