...
export default class UpdatePicklistV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:sys:command:update-picklist:1-0-0', UpdatePicklistV1,
      [],
      [
...
MessageResolver.register('acme:sys:command:update-picklist', UpdatePicklistV1);
