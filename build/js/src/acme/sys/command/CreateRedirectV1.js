...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:sys:command:create-redirect:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:sys:command:create-redirect';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:sys:command:create-redirect:v1';
