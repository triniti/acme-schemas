// @link http://acme-schemas.triniti.io/json-schema/acme/sys/command/update-redirect/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:sys:command:update-redirect:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:sys:command:update-redirect';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:sys:command:update-redirect:v1';
