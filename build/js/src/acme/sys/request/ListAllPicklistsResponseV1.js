// @link http://acme-schemas.triniti.io/json-schema/acme/sys/request/list-all-picklists-response/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:sys:request:list-all-picklists-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:sys:request:list-all-picklists-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:sys:request:list-all-picklists-response:v1';
