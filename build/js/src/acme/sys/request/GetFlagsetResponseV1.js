...
export default class GetFlagsetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:sys:request:get-flagset-response:1-0-0', GetFlagsetResponseV1,
      [],
      [
...
MessageResolver.register('acme:sys:request:get-flagset-response', GetFlagsetResponseV1);
