...
export default class GetPicklistResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:sys:request:get-picklist-response:1-0-0', GetPicklistResponseV1,
      [],
      [
...
MessageResolver.register('acme:sys:request:get-picklist-response', GetPicklistResponseV1);
