// @link http://acme-schemas.triniti.io/json-schema/acme/sys/node/flagset/1-0-0.json#
...
const M = FlagsetV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:sys:node:flagset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:sys:node:flagset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:sys:node:flagset:v1';
