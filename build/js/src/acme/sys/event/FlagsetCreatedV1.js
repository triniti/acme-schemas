// @link http://acme-schemas.triniti.io/json-schema/acme/sys/event/flagset-created/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:sys:event:flagset-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:sys:event:flagset-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:sys:event:flagset-created:v1';
