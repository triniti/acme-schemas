...
export default class GetPersonRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:people:request:get-person-request:1-0-0', GetPersonRequestV1,
      [],
      [
...
MessageResolver.register('acme:people:request:get-person-request', GetPersonRequestV1);
