...
export default class SponsorExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:event:sponsor-expired:1-0-0', SponsorExpiredV1,
      [],
      [
...
MessageResolver.register('acme:boost:event:sponsor-expired', SponsorExpiredV1);
