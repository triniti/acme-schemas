...
export default class SponsorRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:event:sponsor-renamed:1-0-0', SponsorRenamedV1,
      [],
      [
...
MessageResolver.register('acme:boost:event:sponsor-renamed', SponsorRenamedV1);
