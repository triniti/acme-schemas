...
export default class SponsorCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:event:sponsor-created:1-0-0', SponsorCreatedV1,
      [],
      [
...
MessageResolver.register('acme:boost:event:sponsor-created', SponsorCreatedV1);
