...
export default class SearchSponsorsResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:request:search-sponsors-response:1-0-0', SearchSponsorsResponseV1,
      [],
      [
...
MessageResolver.register('acme:boost:request:search-sponsors-response', SearchSponsorsResponseV1);
