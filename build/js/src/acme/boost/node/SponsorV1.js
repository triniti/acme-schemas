// @link http://acme-schemas.triniti.io/json-schema/acme/boost/node/sponsor/1-0-0.json#
...
export default class SponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:node:sponsor:1-0-0', SponsorV1,
      [],
      [
...
MessageResolver.register('acme:boost:node:sponsor', SponsorV1);
