// @link http://acme-schemas.triniti.io/json-schema/acme/boost/command/update-sponsor/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:boost:command:update-sponsor:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:boost:command:update-sponsor';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:boost:command:update-sponsor:v1';
