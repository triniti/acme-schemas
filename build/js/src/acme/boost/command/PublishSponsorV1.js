...
export default class PublishSponsorV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:boost:command:publish-sponsor:1-0-0', PublishSponsorV1,
      [],
      [
...
MessageResolver.register('acme:boost:command:publish-sponsor', PublishSponsorV1);
