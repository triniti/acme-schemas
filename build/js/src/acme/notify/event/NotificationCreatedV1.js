// @link http://acme-schemas.triniti.io/json-schema/acme/notify/event/notification-created/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:notify:event:notification-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:notify:event:notification-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-created:v1';
