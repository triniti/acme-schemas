// @link http://acme-schemas.triniti.io/json-schema/acme/notify/command/send-notification/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:notify:command:send-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:notify:command:send-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:notify:command:send-notification:v1';
