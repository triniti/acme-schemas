...
export default class SendNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:command:send-notification:1-0-0', SendNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:command:send-notification', SendNotificationV1);
