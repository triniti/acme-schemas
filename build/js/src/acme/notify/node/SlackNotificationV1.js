// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/slack-notification/1-0-0.json#
...
export default class SlackNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:slack-notification:1-0-0', SlackNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:slack-notification', SlackNotificationV1);
