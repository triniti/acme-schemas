// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/apple-news-notification/1-0-0.json#
...
export default class AppleNewsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:apple-news-notification:1-0-0', AppleNewsNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:apple-news-notification', AppleNewsNotificationV1);
