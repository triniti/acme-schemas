// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/browser-notification/1-0-0.json#
...
export default class BrowserNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:browser-notification:1-0-0', BrowserNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:browser-notification', BrowserNotificationV1);
