// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/android-notification/1-0-0.json#
...
export default class AndroidNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:android-notification:1-0-0', AndroidNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:android-notification', AndroidNotificationV1);
