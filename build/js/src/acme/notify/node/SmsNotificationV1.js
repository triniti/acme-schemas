// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/sms-notification/1-0-0.json#
...
export default class SmsNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:sms-notification:1-0-0', SmsNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:sms-notification', SmsNotificationV1);
