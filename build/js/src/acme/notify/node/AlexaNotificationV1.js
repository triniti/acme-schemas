// @link http://acme-schemas.triniti.io/json-schema/acme/notify/node/alexa-notification/1-0-0.json#
...
export default class AlexaNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:node:alexa-notification:1-0-0', AlexaNotificationV1,
      [],
      [
...
MessageResolver.register('acme:notify:node:alexa-notification', AlexaNotificationV1);
