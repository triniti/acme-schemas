...
export default class GetNotificationResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:notify:request:get-notification-response:1-0-0', GetNotificationResponseV1,
      [],
      [
...
MessageResolver.register('acme:notify:request:get-notification-response', GetNotificationResponseV1);
