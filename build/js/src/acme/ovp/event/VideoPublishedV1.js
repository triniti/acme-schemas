// @link http://acme-schemas.triniti.io/json-schema/acme/ovp/event/video-published/1-0-0.json#
...
export default class VideoPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:ovp:event:video-published:1-0-0', VideoPublishedV1,
      [],
      [
...
MessageResolver.register('acme:ovp:event:video-published', VideoPublishedV1);
