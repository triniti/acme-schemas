// @link http://acme-schemas.triniti.io/json-schema/acme/ovp/event/video-unpublished/1-0-0.json#
...
import TrinitiOvpVideoUnpublishedV1Mixin from '@triniti/schemas/triniti/ovp/mixin/video-unpublished/VideoUnpublishedV1Mixin';
...
export default class VideoUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:ovp:event:video-unpublished:1-0-0', VideoUnpublishedV1,
      [],
      [
...
MessageResolver.register('acme:ovp:event:video-unpublished', VideoUnpublishedV1);
