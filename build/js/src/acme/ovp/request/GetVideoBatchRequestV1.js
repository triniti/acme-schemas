...
export default class GetVideoBatchRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:ovp:request:get-video-batch-request:1-0-0', GetVideoBatchRequestV1,
      [],
      [
...
MessageResolver.register('acme:ovp:request:get-video-batch-request', GetVideoBatchRequestV1);
