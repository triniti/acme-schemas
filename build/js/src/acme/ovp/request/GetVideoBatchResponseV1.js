// @link http://acme-schemas.gdbots.io/json-schema/acme/ovp/request/get-video-batch-response/1-0-0.json#
...
export default class GetVideoBatchResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:ovp:request:get-video-batch-response:1-0-0', GetVideoBatchResponseV1,
      [],
      [
...
MessageResolver.register('acme:ovp:request:get-video-batch-response', GetVideoBatchResponseV1);
