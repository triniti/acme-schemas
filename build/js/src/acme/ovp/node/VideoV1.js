...
const M = VideoV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:ovp:node:video:1-0-3';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:ovp:node:video';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:ovp:node:video:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:ncr:mixin:node:v1',
  'gdbots:ncr:mixin:node',
  'triniti:ovp:mixin:video:v1',
  'triniti:ovp:mixin:video',
  'triniti:ovp.jwplayer:mixin:has-media:v1',
  'triniti:ovp.jwplayer:mixin:has-media',
  'triniti:ovp.kaltura:mixin:has-entry:v1',
  'triniti:ovp.kaltura:mixin:has-entry',
  'triniti:ovp.medialive:mixin:has-channel:v1',
