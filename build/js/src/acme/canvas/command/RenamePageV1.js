...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:canvas:command:rename-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:canvas:command:rename-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:canvas:command:rename-page:v1';
