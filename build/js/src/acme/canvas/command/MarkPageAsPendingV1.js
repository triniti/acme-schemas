...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:canvas:command:mark-page-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:canvas:command:mark-page-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:canvas:command:mark-page-as-pending:v1';
