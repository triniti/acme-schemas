// @link http://acme-schemas.triniti.io/json-schema/acme/canvas/event/page-published/1-0-0.json#
...
import TrinitiCanvasPagePublishedV1Mixin from '@triniti/schemas/triniti/canvas/mixin/page-published/PagePublishedV1Mixin';
...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:canvas:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('acme:canvas:event:page-published', PagePublishedV1);
