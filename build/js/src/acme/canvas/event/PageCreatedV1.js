...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:canvas:event:page-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:canvas:event:page-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-created:v1';
