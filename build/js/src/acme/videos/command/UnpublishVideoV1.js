...
import TrinitiVideosUnpublishVideoV1Mixin from '@triniti/schemas/triniti/videos/mixin/unpublish-video/UnpublishVideoV1Mixin';
...
export default class UnpublishVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:command:unpublish-video:1-0-0', UnpublishVideoV1,
      [],
      [
...
MessageResolver.register('acme:videos:command:unpublish-video', UnpublishVideoV1);
