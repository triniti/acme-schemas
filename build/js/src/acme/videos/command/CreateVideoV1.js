...
import TrinitiVideosCreateVideoV1Mixin from '@triniti/schemas/triniti/videos/mixin/create-video/CreateVideoV1Mixin';
...
export default class CreateVideoV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:command:create-video:1-0-0', CreateVideoV1,
      [],
      [
...
MessageResolver.register('acme:videos:command:create-video', CreateVideoV1);
