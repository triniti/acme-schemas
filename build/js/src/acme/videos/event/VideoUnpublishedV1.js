...
import TrinitiVideosVideoUnpublishedV1Mixin from '@triniti/schemas/triniti/videos/mixin/video-unpublished/VideoUnpublishedV1Mixin';
...
export default class VideoUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:event:video-unpublished:1-0-0', VideoUnpublishedV1,
      [],
      [
        GdbotsPbjxEventV1Mixin.create(),
        GdbotsNcrNodeUnpublishedV1Mixin.create(),
        TrinitiVideosVideoUnpublishedV1Mixin.create(),
...
MessageResolver.register('acme:videos:event:video-unpublished', VideoUnpublishedV1);
