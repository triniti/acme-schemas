...
export default class VideoScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:event:video-scheduled:1-0-0', VideoScheduledV1,
      [],
      [
...
MessageResolver.register('acme:videos:event:video-scheduled', VideoScheduledV1);
