// @link http://acme-schemas.gdbots.io/json-schema/acme/videos/event/video-updated/1-0-0.json#
...
import TrinitiVideosVideoUpdatedV1Mixin from '@triniti/schemas/triniti/videos/mixin/video-updated/VideoUpdatedV1Mixin';
...
export default class VideoUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:event:video-updated:1-0-0', VideoUpdatedV1,
      [],
      [
...
MessageResolver.register('acme:videos:event:video-updated', VideoUpdatedV1);
