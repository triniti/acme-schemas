...
import TrinitiVideosVideoPublishedV1Mixin from '@triniti/schemas/triniti/videos/mixin/video-published/VideoPublishedV1Mixin';
...
export default class VideoPublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:videos:event:video-published:1-0-0', VideoPublishedV1,
      [],
      [
...
MessageResolver.register('acme:videos:event:video-published', VideoPublishedV1);
