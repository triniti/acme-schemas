...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:command:create-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:command:create-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:command:create-user:v1';
