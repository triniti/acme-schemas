...
const M = PatchUserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:command:patch-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:command:patch-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:command:patch-user:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:patch-node:v1',
