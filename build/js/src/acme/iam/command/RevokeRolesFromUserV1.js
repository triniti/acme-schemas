// @link http://acme-schemas.triniti.io/json-schema/acme/iam/command/revoke-roles-from-user/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:command:revoke-roles-from-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:command:revoke-roles-from-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:command:revoke-roles-from-user:v1';
