...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:command:delete-role:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:command:delete-role';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:command:delete-role:v1';
