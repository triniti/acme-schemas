// @link http://acme-schemas.triniti.io/json-schema/acme/iam/command/delete-app/1-0-0.json#
...
const M = DeleteAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:command:delete-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:command:delete-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:command:delete-app:v1';
