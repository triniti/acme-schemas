...
export default class GetAppHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:request:get-app-history-request:1-0-0', GetAppHistoryRequestV1,
      [],
      [
...
MessageResolver.register('acme:iam:request:get-app-history-request', GetAppHistoryRequestV1);
