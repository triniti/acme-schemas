...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:request:get-user-history-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:request:get-user-history-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-user-history-response:v1';
