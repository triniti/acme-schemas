// @link http://acme-schemas.triniti.io/json-schema/acme/iam/event/user-roles-revoked/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:iam:event:user-roles-revoked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:iam:event:user-roles-revoked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-roles-revoked:v1';
