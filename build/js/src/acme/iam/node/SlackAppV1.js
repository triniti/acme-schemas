// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/slack-app/1-0-0.json#
...
export default class SlackAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:slack-app:1-0-0', SlackAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:slack-app', SlackAppV1);
