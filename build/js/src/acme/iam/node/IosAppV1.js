// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/ios-app/1-0-0.json#
...
export default class IosAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:ios-app:1-0-0', IosAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:ios-app', IosAppV1);
