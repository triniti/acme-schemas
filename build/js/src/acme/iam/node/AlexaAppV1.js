// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/alexa-app/1-0-0.json#
...
export default class AlexaAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:alexa-app:1-0-0', AlexaAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:alexa-app', AlexaAppV1);
