// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/apple-news-app/1-0-0.json#
...
export default class AppleNewsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:apple-news-app:1-0-0', AppleNewsAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:apple-news-app', AppleNewsAppV1);
