// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/email-app/1-0-0.json#
...
export default class EmailAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:email-app:1-0-0', EmailAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:email-app', EmailAppV1);
