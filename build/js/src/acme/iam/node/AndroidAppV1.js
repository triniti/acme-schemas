// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/android-app/1-0-0.json#
...
export default class AndroidAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:android-app:1-0-0', AndroidAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:android-app', AndroidAppV1);
