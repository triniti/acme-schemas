// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/sms-app/1-0-0.json#
...
export default class SmsAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:sms-app:1-0-0', SmsAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:sms-app', SmsAppV1);
