// @link http://acme-schemas.triniti.io/json-schema/acme/iam/node/browser-app/1-0-0.json#
...
export default class BrowserAppV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:iam:node:browser-app:1-0-0', BrowserAppV1,
      [],
      [
...
MessageResolver.register('acme:iam:node:browser-app', BrowserAppV1);
