...
export default class SearchCategoriesResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:taxonomy:request:search-categories-response:1-0-0', SearchCategoriesResponseV1,
      [],
      [
...
MessageResolver.register('acme:taxonomy:request:search-categories-response', SearchCategoriesResponseV1);
