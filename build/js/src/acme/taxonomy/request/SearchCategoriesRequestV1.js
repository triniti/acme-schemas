...
export default class SearchCategoriesRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:taxonomy:request:search-categories-request:1-0-0', SearchCategoriesRequestV1,
      [],
      [
...
MessageResolver.register('acme:taxonomy:request:search-categories-request', SearchCategoriesRequestV1);
