...
import TrinitiTaxonomyChannelDeletedV1Mixin from '@triniti/schemas/triniti/taxonomy/mixin/channel-deleted/ChannelDeletedV1Mixin';
...
export default class ChannelDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:taxonomy:event:channel-deleted:1-0-0', ChannelDeletedV1,
      [],
      [
...
MessageResolver.register('acme:taxonomy:event:channel-deleted', ChannelDeletedV1);
