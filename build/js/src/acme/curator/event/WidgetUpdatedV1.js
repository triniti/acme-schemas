...
export default class WidgetUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:event:widget-updated:1-0-0', WidgetUpdatedV1,
      [],
      [
...
MessageResolver.register('acme:curator:event:widget-updated', WidgetUpdatedV1);
