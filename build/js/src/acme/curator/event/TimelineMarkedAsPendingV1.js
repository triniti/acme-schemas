...
export default class TimelineMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:event:timeline-marked-as-pending:1-0-0', TimelineMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('acme:curator:event:timeline-marked-as-pending', TimelineMarkedAsPendingV1);
