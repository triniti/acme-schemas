// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/blogroll-widget/1-0-0.json#
...
export default class BlogrollWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:blogroll-widget:1-0-0', BlogrollWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:blogroll-widget', BlogrollWidgetV1);
