...
export default class ShowtimesWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:showtimes-widget:1-0-0', ShowtimesWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:showtimes-widget', ShowtimesWidgetV1);
