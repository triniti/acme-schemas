// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/gallery-widget/1-0-0.json#
...
export default class GalleryWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:gallery-widget:1-0-0', GalleryWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:gallery-widget', GalleryWidgetV1);
