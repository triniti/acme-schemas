// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/slider-widget/1-0-0.json#
...
export default class SliderWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:slider-widget:1-0-0', SliderWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:slider-widget', SliderWidgetV1);
