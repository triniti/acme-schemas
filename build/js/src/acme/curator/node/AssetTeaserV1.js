// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/asset-teaser/1-0-0.json#
...
export default class AssetTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:asset-teaser', AssetTeaserV1);
