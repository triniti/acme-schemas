// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/media-list-widget/1-0-0.json#
...
export default class MediaListWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:media-list-widget:1-0-0', MediaListWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:media-list-widget', MediaListWidgetV1);
