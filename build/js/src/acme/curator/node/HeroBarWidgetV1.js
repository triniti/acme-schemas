// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:hero-bar-widget', HeroBarWidgetV1);
