// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:article-teaser', ArticleTeaserV1);
