// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/tetris-widget/1-0-0.json#
...
export default class TetrisWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:tetris-widget:1-0-0', TetrisWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:tetris-widget', TetrisWidgetV1);
