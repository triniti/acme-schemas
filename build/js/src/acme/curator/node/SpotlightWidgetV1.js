// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:spotlight-widget', SpotlightWidgetV1);
