// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/link-teaser/1-0-0.json#
...
export default class LinkTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:link-teaser:1-0-0', LinkTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:link-teaser', LinkTeaserV1);
