...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:category-teaser', CategoryTeaserV1);
