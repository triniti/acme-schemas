// @link http://acme-schemas.triniti.io/json-schema/acme/curator/node/poll-teaser/1-0-0.json#
...
export default class PollTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:node:poll-teaser', PollTeaserV1);
