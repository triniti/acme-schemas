...
export default class GetGalleryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:request:get-gallery-request:1-0-0', GetGalleryRequestV1,
      [],
      [
...
MessageResolver.register('acme:curator:request:get-gallery-request', GetGalleryRequestV1);
