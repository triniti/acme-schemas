...
export default class GetTimelineHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:request:get-timeline-history-request:1-0-0', GetTimelineHistoryRequestV1,
      [],
      [
...
MessageResolver.register('acme:curator:request:get-timeline-history-request', GetTimelineHistoryRequestV1);
