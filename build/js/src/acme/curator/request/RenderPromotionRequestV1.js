...
export default class RenderPromotionRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:request:render-promotion-request:1-0-0', RenderPromotionRequestV1,
      [],
      [
...
MessageResolver.register('acme:curator:request:render-promotion-request', RenderPromotionRequestV1);
