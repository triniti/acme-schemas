...
export default class GetTimelineRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:request:get-timeline-request:1-0-0', GetTimelineRequestV1,
      [],
      [
...
MessageResolver.register('acme:curator:request:get-timeline-request', GetTimelineRequestV1);
