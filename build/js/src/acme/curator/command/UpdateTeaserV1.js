// @link http://acme-schemas.triniti.io/json-schema/acme/curator/command/update-teaser/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:curator:command:update-teaser:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:curator:command:update-teaser';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-teaser:v1';
