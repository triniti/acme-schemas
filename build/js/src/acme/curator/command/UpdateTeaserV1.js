...
export default class UpdateTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:update-teaser:1-0-0', UpdateTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:update-teaser', UpdateTeaserV1);
