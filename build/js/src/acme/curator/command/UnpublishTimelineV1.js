...
export default class UnpublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:unpublish-timeline:1-0-0', UnpublishTimelineV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:unpublish-timeline', UnpublishTimelineV1);
