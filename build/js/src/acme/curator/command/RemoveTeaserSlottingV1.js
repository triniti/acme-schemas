...
export default class RemoveTeaserSlottingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:remove-teaser-slotting:1-0-0', RemoveTeaserSlottingV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:remove-teaser-slotting', RemoveTeaserSlottingV1);
