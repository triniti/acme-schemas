// @link http://acme-schemas.triniti.io/json-schema/acme/curator/command/remove-teaser-slotting/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:curator:command:remove-teaser-slotting:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:curator:command:remove-teaser-slotting';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:curator:command:remove-teaser-slotting:v1';
