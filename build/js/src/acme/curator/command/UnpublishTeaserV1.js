...
export default class UnpublishTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:unpublish-teaser:1-0-0', UnpublishTeaserV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:unpublish-teaser', UnpublishTeaserV1);
