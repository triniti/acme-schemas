...
export default class PublishTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:publish-timeline:1-0-0', PublishTimelineV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:publish-timeline', PublishTimelineV1);
