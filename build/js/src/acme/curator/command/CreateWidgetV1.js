...
export default class CreateWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:curator:command:create-widget:1-0-0', CreateWidgetV1,
      [],
      [
...
MessageResolver.register('acme:curator:command:create-widget', CreateWidgetV1);
