...
import TrinitiPagesPageExpiredV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-expired/PageExpiredV1Mixin';
...
export default class PageExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-expired:1-0-0', PageExpiredV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-expired', PageExpiredV1);
