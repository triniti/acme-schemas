...
import TrinitiPagesPageCreatedV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-created/PageCreatedV1Mixin';
...
export default class PageCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-created:1-0-0', PageCreatedV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-created', PageCreatedV1);
