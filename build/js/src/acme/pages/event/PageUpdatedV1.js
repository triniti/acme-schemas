...
import TrinitiPagesPageUpdatedV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-updated/PageUpdatedV1Mixin';
...
export default class PageUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-updated:1-0-0', PageUpdatedV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-updated', PageUpdatedV1);
