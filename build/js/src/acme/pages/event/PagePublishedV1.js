...
import TrinitiPagesPagePublishedV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-published/PagePublishedV1Mixin';
...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-published', PagePublishedV1);
