...
import TrinitiPagesPageUnpublishedV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-unpublished/PageUnpublishedV1Mixin';
...
export default class PageUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-unpublished:1-0-0', PageUnpublishedV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-unpublished', PageUnpublishedV1);
