// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-scheduled/1-0-0.json#
...
import TrinitiPagesPageScheduledV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-scheduled/PageScheduledV1Mixin';
...
export default class PageScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-scheduled:1-0-0', PageScheduledV1,
      [],
      [
        GdbotsPbjxEventV1Mixin.create(),
        GdbotsNcrNodeScheduledV1Mixin.create(),
        TrinitiPagesPageScheduledV1Mixin.create(),
...
MessageResolver.register('acme:pages:event:page-scheduled', PageScheduledV1);
