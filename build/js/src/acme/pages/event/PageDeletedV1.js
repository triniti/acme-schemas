...
import TrinitiPagesPageDeletedV1Mixin from '@triniti/schemas/triniti/pages/mixin/page-deleted/PageDeletedV1Mixin';
...
export default class PageDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:event:page-deleted:1-0-0', PageDeletedV1,
      [],
      [
...
MessageResolver.register('acme:pages:event:page-deleted', PageDeletedV1);
