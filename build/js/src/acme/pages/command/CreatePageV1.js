...
import TrinitiPagesCreatePageV1Mixin from '@triniti/schemas/triniti/pages/mixin/create-page/CreatePageV1Mixin';
...
export default class CreatePageV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:pages:command:create-page:1-0-0', CreatePageV1,
      [],
      [
...
MessageResolver.register('acme:pages:command:create-page', CreatePageV1);
