...
import TrinitiNewsArticleRenamedV1Mixin from '@triniti/schemas/triniti/news/mixin/article-renamed/ArticleRenamedV1Mixin';
...
export default class ArticleRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:news:event:article-renamed:1-0-0', ArticleRenamedV1,
      [],
      [
...
MessageResolver.register('acme:news:event:article-renamed', ArticleRenamedV1);
