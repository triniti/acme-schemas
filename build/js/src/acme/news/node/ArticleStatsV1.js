// @link http://acme-schemas.triniti.io/json-schema/acme/news/node/article-stats/1-0-0.json#
...
export default class ArticleStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:news:node:article-stats:1-0-0', ArticleStatsV1,
      [],
      [
...
MessageResolver.register('acme:news:node:article-stats', ArticleStatsV1);
