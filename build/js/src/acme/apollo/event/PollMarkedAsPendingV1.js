...
import TrinitiApolloPollMarkedAsPendingV1Mixin from '@triniti/schemas/triniti/apollo/mixin/poll-marked-as-pending/PollMarkedAsPendingV1Mixin';
...
export default class PollMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:apollo:event:poll-marked-as-pending:1-0-0', PollMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('acme:apollo:event:poll-marked-as-pending', PollMarkedAsPendingV1);
