// @link http://acme-schemas.triniti.io/json-schema/acme/apollo/node/reactions/1-0-0.json#
...
import TrinitiApolloReactionsV1Mixin from '@triniti/schemas/triniti/apollo/mixin/reactions/ReactionsV1Mixin.js';
import UuidIdentifier from '@gdbots/pbj/well-known/UuidIdentifier.js';

export default class ReactionsV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ReactionsV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:acme:apollo:node:reactions:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'acme:apollo:node:reactions';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'acme:apollo:node:reactions:v1';
...
TrinitiApolloReactionsV1Mixin(M);
