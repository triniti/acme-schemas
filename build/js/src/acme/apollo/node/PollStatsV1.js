// @link http://acme-schemas.triniti.io/json-schema/acme/apollo/node/poll-stats/1-0-0.json#
...
export default class PollStatsV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:apollo:node:poll-stats:1-0-0', PollStatsV1,
      [],
      [
...
MessageResolver.register('acme:apollo:node:poll-stats', PollStatsV1);
