...
import TrinitiApolloCreatePollV1Mixin from '@triniti/schemas/triniti/apollo/mixin/create-poll/CreatePollV1Mixin';
...
export default class CreatePollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:acme:apollo:command:create-poll:1-0-0', CreatePollV1,
      [],
      [
...
MessageResolver.register('acme:apollo:command:create-poll', CreatePollV1);
