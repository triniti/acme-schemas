...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-published:v1';
    const MIXINS = [
