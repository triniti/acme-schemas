...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-renamed:v1';
    const MIXINS = [
