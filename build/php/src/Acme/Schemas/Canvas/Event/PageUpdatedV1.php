...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-updated:v1';
    const MIXINS = [
