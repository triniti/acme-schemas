...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-scheduled:v1';
    const MIXINS = [
