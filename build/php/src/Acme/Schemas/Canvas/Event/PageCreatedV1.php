...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-created:v1';
    const MIXINS = [
