...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-unpublished:v1';
    const MIXINS = [
