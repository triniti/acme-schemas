...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-marked-as-pending:v1';
    const MIXINS = [
