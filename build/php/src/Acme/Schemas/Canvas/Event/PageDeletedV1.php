...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-deleted:v1';
    const MIXINS = [
