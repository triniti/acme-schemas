...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-marked-as-draft:v1';
    const MIXINS = [
