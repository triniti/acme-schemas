...
{
    const SCHEMA_ID = 'pbj:acme:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:event:page-expired:v1';
    const MIXINS = [
