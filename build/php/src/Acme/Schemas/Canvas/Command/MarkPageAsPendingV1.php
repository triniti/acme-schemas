...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:mark-page-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:mark-page-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:mark-page-as-pending:v1';
    const MIXINS = [
