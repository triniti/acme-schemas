...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:create-page:v1';
    const MIXINS = [
