...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:rename-page:v1';
    const MIXINS = [
