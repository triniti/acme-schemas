...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:publish-page:v1';
    const MIXINS = [
