...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:update-page:v1';
    const MIXINS = [
