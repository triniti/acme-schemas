...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:delete-page:v1';
    const MIXINS = [
