...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:mark-page-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:mark-page-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:mark-page-as-draft:v1';
    const MIXINS = [
