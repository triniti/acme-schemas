...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:unpublish-page:v1';
    const MIXINS = [
