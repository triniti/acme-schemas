<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/canvas/command/expire-page/1-0-0.json#
    ...
    TrinitiCanvasExpirePageV1
{
    ...
    {
        return new Schema('pbj:acme:canvas:command:expire-page:1-0-0', __CLASS__,
            [],
            [
