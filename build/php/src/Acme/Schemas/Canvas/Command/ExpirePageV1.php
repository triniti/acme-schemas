...
{
    const SCHEMA_ID = 'pbj:acme:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:command:expire-page:v1';
    const MIXINS = [
