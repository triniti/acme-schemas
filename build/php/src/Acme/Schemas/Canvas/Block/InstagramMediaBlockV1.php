...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:instagram-media-block:v1';
    const MIXINS = [
