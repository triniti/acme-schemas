...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:facebook-post-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:facebook-post-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:facebook-post-block:v1';
    const MIXINS = [
