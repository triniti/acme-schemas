...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:spotify-track-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:spotify-track-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:spotify-track-block:v1';
    const MIXINS = [
