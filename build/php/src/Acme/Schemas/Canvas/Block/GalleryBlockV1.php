...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:gallery-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:gallery-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:gallery-block:v1';
    const MIXINS = [
