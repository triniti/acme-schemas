...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:text-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:text-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:text-block:v1';
    const MIXINS = [
