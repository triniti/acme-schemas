...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:eme-form-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:eme-form-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:eme-form-block:v1';
    const MIXINS = [
