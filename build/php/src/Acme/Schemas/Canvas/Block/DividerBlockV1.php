...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:divider-block:v1';
    const MIXINS = [
