...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:pinterest-pin-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:pinterest-pin-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:pinterest-pin-block:v1';
    const MIXINS = [
