...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:soundcloud-audio-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:soundcloud-audio-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:soundcloud-audio-block:v1';
    const MIXINS = [
