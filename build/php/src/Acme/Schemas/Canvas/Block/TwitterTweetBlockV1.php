...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:twitter-tweet-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:twitter-tweet-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:twitter-tweet-block:v1';
    const MIXINS = [
