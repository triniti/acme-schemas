...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:vimeo-video-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:vimeo-video-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:vimeo-video-block:v1';
    const MIXINS = [
