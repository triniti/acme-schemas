...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:spotify-embed-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:spotify-embed-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:spotify-embed-block:v1';
    const MIXINS = [
