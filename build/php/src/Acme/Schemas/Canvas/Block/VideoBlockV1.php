...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:video-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:video-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:video-block:v1';
    const MIXINS = [
