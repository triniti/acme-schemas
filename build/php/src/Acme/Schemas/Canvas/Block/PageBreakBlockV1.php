...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:page-break-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:page-break-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:page-break-block:v1';
    const MIXINS = [
