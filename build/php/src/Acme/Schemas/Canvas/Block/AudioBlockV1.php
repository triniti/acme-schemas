...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:audio-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:audio-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:audio-block:v1';
    const MIXINS = [
