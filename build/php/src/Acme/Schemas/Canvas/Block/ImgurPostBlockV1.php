...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:imgur-post-block:v1';
    const MIXINS = [
