...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:poll-grid-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:poll-grid-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:poll-grid-block:v1';
    const MIXINS = [
