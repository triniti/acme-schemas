...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:google-map-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:google-map-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:google-map-block:v1';
    const MIXINS = [
