...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:iframe-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:iframe-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:iframe-block:v1';
    const MIXINS = [
