...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:poll-block:v1';
    const MIXINS = [
