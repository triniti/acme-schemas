...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:youtube-playlist-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:youtube-playlist-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:youtube-playlist-block:v1';
    const MIXINS = [
