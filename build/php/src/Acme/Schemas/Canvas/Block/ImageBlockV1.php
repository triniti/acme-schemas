...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:image-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:image-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:image-block:v1';
    const MIXINS = [
