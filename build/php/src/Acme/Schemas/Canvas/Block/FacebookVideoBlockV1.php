...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:facebook-video-block:v1';
    const MIXINS = [
