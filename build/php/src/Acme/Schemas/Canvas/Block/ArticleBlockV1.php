...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:article-block:v1';
    const MIXINS = [
