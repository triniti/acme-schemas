...
{
    const SCHEMA_ID = 'pbj:acme:canvas:block:code-block:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:block:code-block';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:block:code-block:v1';
    const MIXINS = [
