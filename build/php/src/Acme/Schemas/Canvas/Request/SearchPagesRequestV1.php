...
{
    const SCHEMA_ID = 'pbj:acme:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:request:search-pages-request:v1';
    const MIXINS = [
