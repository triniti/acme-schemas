...
{
    const SCHEMA_ID = 'pbj:acme:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:request:search-pages-response:v1';
    const MIXINS = [
