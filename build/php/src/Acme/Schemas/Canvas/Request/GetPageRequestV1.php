...
{
    const SCHEMA_ID = 'pbj:acme:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:request:get-page-request:v1';
    const MIXINS = [
