...
{
    const SCHEMA_ID = 'pbj:acme:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:canvas:request:get-page-history-response:v1';
    const MIXINS = [
