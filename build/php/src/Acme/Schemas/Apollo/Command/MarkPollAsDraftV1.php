...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:mark-poll-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:mark-poll-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:mark-poll-as-draft:v1';
    const MIXINS = [
