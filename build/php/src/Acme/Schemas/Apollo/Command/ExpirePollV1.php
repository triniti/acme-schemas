...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:expire-poll:v1';
    const MIXINS = [
