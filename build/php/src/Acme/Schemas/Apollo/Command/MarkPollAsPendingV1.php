...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:mark-poll-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:mark-poll-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:mark-poll-as-pending:v1';
    const MIXINS = [
