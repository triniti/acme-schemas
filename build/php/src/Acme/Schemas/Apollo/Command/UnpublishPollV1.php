...
use Triniti\Schemas\Apollo\Mixin\UnpublishPoll\UnpublishPollV1 as TrinitiApolloUnpublishPollV1;
use Triniti\Schemas\Apollo\Mixin\UnpublishPoll\UnpublishPollV1Mixin as TrinitiApolloUnpublishPollV1Mixin;

final class UnpublishPollV1 extends AbstractMessage implements
    UnpublishPoll,
    GdbotsPbjxCommandV1,
    GdbotsNcrUnpublishNodeV1,
    TrinitiApolloUnpublishPollV1
{
    ...
    {
        return new Schema('pbj:acme:apollo:command:unpublish-poll:1-0-0', __CLASS__,
            [],
            [
