...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:unpublish-poll:v1';
    const MIXINS = [
