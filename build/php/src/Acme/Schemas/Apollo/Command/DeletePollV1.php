...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:delete-poll:v1';
    const MIXINS = [
