...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:create-poll:v1';
    const MIXINS = [
