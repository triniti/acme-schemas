...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:cast-vote:v1';
    const MIXINS = [
