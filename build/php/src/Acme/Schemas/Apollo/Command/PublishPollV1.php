...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:publish-poll:v1';
    const MIXINS = [
