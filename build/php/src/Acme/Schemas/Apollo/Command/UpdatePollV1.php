...
{
    const SCHEMA_ID = 'pbj:acme:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:command:update-poll:v1';
    const MIXINS = [
