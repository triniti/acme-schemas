...
use Triniti\Schemas\Apollo\Mixin\Reactions\ReactionsV1Mixin as TrinitiApolloReactionsV1Mixin;

final class ReactionsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:acme:apollo:node:reactions:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:node:reactions';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:node:reactions:v1';
    const MIXINS = [
    ...
    use TrinitiApolloReactionsV1Mixin;
