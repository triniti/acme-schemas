...
{
    const SCHEMA_ID = 'pbj:acme:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:node:poll-stats:v1';
    const MIXINS = [
