...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-marked-as-draft:v1';
    const MIXINS = [
