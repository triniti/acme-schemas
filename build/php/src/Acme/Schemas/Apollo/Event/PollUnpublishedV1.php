...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-unpublished:v1';
    const MIXINS = [
