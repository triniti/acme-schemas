...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-published:v1';
    const MIXINS = [
