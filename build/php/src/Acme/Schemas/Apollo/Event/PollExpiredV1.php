...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-expired:v1';
    const MIXINS = [
