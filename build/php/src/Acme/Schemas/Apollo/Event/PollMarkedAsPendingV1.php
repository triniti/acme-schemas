...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [
