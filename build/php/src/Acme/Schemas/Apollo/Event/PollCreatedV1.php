...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-created:v1';
    const MIXINS = [
