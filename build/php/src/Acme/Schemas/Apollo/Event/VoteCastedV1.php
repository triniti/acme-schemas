...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:vote-casted:v1';
    const MIXINS = [
