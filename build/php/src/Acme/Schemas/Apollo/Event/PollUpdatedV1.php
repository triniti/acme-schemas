...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-updated:v1';
    const MIXINS = [
