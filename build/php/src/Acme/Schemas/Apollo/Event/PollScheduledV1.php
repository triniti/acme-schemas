...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-scheduled:v1';
    const MIXINS = [
