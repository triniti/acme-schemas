...
{
    const SCHEMA_ID = 'pbj:acme:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:event:poll-deleted:v1';
    const MIXINS = [
