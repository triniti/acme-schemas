...
{
    const SCHEMA_ID = 'pbj:acme:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:request:search-polls-response:v1';
    const MIXINS = [
