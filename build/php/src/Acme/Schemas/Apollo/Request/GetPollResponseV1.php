...
{
    const SCHEMA_ID = 'pbj:acme:apollo:request:get-poll-response:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:request:get-poll-response';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:request:get-poll-response:v1';
    const MIXINS = [
