...
{
    const SCHEMA_ID = 'pbj:acme:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:request:search-polls-request:v1';
    const MIXINS = [
