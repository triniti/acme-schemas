...
{
    const SCHEMA_ID = 'pbj:acme:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:request:get-poll-request:v1';
    const MIXINS = [
