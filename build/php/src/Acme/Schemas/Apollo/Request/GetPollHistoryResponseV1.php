...
{
    const SCHEMA_ID = 'pbj:acme:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:apollo:request:get-poll-history-response:v1';
    const MIXINS = [
