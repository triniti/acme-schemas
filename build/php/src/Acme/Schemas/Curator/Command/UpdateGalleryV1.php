...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-gallery:v1';
    const MIXINS = [
