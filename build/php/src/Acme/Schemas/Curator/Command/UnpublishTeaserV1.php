...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:unpublish-teaser:v1';
    const MIXINS = [
