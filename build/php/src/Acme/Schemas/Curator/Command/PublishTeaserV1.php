...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:publish-teaser:v1';
    const MIXINS = [
