...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:expire-teaser:v1';
    const MIXINS = [
