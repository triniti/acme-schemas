...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:sync-teaser:v1';
    const MIXINS = [
