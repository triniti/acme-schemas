...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:create-widget:v1';
    const MIXINS = [
