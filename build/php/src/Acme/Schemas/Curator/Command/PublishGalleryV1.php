...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:publish-gallery:v1';
    const MIXINS = [
