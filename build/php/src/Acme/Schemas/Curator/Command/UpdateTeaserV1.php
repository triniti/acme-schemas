...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-teaser:v1';
    const MIXINS = [
