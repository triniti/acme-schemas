...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:rename-timeline:v1';
    const MIXINS = [
