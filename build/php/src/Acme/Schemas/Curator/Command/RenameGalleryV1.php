...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:rename-gallery:v1';
    const MIXINS = [
