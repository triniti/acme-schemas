...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:delete-timeline:v1';
    const MIXINS = [
