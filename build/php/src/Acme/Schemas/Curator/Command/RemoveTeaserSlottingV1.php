...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:remove-teaser-slotting:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:remove-teaser-slotting';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:remove-teaser-slotting:v1';
    const MIXINS = [
