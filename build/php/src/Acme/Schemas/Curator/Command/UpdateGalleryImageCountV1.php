...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-gallery-image-count:v1';
    const MIXINS = [
