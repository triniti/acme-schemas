...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:unpublish-timeline:v1';
    const MIXINS = [
