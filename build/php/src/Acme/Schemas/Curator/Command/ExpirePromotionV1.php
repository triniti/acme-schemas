...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:expire-promotion:v1';
    const MIXINS = [
