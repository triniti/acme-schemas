...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:create-gallery:v1';
    const MIXINS = [
