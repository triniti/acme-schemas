...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:delete-promotion:v1';
    const MIXINS = [
