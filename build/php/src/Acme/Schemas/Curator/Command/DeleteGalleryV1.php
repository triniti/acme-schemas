...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:delete-gallery:v1';
    const MIXINS = [
