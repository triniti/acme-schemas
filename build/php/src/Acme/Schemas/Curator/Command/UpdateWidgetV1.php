...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-widget:v1';
    const MIXINS = [
