...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:delete-teaser:v1';
    const MIXINS = [
