...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:expire-gallery:v1';
    const MIXINS = [
