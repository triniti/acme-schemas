...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:publish-timeline:v1';
    const MIXINS = [
