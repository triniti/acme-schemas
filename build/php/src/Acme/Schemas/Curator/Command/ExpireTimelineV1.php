...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:expire-timeline:v1';
    const MIXINS = [
