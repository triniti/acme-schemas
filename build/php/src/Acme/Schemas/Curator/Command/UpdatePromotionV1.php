...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-promotion:v1';
    const MIXINS = [
