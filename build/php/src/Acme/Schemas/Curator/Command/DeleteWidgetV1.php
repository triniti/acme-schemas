...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:delete-widget:v1';
    const MIXINS = [
