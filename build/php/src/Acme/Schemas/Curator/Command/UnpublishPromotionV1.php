...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:unpublish-promotion:v1';
    const MIXINS = [
