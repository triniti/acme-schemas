...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:create-timeline:v1';
    const MIXINS = [
