...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:mark-teaser-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:mark-teaser-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:mark-teaser-as-draft:v1';
    const MIXINS = [
