...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:unpublish-gallery:v1';
    const MIXINS = [
