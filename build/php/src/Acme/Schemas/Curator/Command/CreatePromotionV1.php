...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:create-promotion:v1';
    const MIXINS = [
