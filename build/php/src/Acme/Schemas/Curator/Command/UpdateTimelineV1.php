...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:update-timeline:v1';
    const MIXINS = [
