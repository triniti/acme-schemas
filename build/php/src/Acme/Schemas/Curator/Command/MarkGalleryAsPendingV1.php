...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:mark-gallery-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:mark-gallery-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:mark-gallery-as-pending:v1';
    const MIXINS = [
