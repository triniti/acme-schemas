...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:create-teaser:v1';
    const MIXINS = [
