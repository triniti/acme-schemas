...
{
    const SCHEMA_ID = 'pbj:acme:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:command:publish-promotion:v1';
    const MIXINS = [
