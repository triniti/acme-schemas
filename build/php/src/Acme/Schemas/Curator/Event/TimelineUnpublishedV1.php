...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-unpublished:v1';
    const MIXINS = [
