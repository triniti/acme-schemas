...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-unpublished:v1';
    const MIXINS = [
