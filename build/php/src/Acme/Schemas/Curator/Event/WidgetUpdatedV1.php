...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:widget-updated:v1';
    const MIXINS = [
