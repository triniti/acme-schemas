...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-created:v1';
    const MIXINS = [
