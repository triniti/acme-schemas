...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-created:v1';
    const MIXINS = [
