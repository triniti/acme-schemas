...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-scheduled:v1';
    const MIXINS = [
