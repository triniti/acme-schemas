...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-renamed:v1';
    const MIXINS = [
