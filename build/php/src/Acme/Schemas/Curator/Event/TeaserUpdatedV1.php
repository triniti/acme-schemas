...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-updated:v1';
    const MIXINS = [
