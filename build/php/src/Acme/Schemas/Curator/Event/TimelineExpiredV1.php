...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-expired:v1';
    const MIXINS = [
