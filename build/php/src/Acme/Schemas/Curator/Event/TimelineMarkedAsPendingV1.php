...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-marked-as-pending:v1';
    const MIXINS = [
