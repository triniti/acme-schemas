...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-scheduled:v1';
    const MIXINS = [
