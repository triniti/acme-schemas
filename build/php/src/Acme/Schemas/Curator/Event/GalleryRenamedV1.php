...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-renamed:v1';
    const MIXINS = [
