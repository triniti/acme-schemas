...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-deleted:v1';
    const MIXINS = [
