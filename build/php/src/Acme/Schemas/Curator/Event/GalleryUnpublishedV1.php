...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-unpublished:v1';
    const MIXINS = [
