...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-updated:v1';
    const MIXINS = [
