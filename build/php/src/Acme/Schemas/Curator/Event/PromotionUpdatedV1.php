...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-updated:v1';
    const MIXINS = [
