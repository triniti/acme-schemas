...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:widget-deleted:v1';
    const MIXINS = [
