...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-created:v1';
    const MIXINS = [
