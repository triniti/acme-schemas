...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-published:v1';
    const MIXINS = [
