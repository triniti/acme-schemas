...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-scheduled:v1';
    const MIXINS = [
