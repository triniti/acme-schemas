...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-created:v1';
    const MIXINS = [
