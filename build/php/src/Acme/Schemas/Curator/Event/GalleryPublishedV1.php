...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-published:v1';
    const MIXINS = [
