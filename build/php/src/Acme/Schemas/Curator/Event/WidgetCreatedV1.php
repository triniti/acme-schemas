...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:widget-created:v1';
    const MIXINS = [
