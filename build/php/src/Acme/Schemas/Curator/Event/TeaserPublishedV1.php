...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-published:v1';
    const MIXINS = [
