...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-expired:v1';
    const MIXINS = [
