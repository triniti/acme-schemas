...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-marked-as-pending:v1';
    const MIXINS = [
