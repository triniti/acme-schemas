...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-expired:v1';
    const MIXINS = [
