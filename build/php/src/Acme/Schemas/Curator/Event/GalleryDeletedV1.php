...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-deleted:v1';
    const MIXINS = [
