...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:timeline-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:timeline-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:timeline-marked-as-draft:v1';
    const MIXINS = [
