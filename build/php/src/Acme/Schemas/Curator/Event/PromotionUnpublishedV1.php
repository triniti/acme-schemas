...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-unpublished:v1';
    const MIXINS = [
