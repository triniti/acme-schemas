...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:gallery-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:gallery-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:gallery-updated:v1';
    const MIXINS = [
