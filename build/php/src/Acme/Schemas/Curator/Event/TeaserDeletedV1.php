...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-deleted:v1';
    const MIXINS = [
