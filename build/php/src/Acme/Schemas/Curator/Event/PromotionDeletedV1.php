...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-deleted:v1';
    const MIXINS = [
