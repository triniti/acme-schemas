...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-scheduled:v1';
    const MIXINS = [
