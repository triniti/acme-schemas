...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:promotion-published:v1';
    const MIXINS = [
