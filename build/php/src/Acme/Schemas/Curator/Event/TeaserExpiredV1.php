...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-expired:v1';
    const MIXINS = [
