...
{
    const SCHEMA_ID = 'pbj:acme:curator:event:teaser-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:event:teaser-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:event:teaser-slotting-removed:v1';
    const MIXINS = [
