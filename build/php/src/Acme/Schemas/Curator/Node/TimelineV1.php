...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:timeline:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:timeline:v1';
    const MIXINS = [
