...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:showtimes-widget:v1';
    const MIXINS = [
