...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:link-teaser:v1';
    const MIXINS = [
