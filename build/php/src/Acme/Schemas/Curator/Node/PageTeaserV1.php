...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:page-teaser:v1';
    const MIXINS = [
