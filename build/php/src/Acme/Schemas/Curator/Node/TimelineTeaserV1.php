...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:timeline-teaser:v1';
    const MIXINS = [
