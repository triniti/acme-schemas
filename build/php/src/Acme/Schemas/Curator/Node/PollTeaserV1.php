...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:poll-teaser:v1';
    const MIXINS = [
