...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:youtube-video-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:youtube-video-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:youtube-video-teaser:v1';
    const MIXINS = [
