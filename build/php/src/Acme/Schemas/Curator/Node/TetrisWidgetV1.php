...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:tetris-widget:v1';
    const MIXINS = [
