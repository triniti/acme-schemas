...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:blogroll-widget:v1';
    const MIXINS = [
