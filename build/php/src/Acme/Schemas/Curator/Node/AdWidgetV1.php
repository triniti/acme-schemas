...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:ad-widget:v1';
    const MIXINS = [
