...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:gallery-widget:v1';
    const MIXINS = [
