...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:slider-widget:v1';
    const MIXINS = [
