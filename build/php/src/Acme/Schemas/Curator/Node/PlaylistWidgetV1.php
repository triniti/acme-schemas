...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:playlist-widget:v1';
    const MIXINS = [
