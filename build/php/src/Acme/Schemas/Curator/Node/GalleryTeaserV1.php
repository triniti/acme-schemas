...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:gallery-teaser:v1';
    const MIXINS = [
