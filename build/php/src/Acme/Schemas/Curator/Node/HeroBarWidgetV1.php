...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:hero-bar-widget:v1';
    const MIXINS = [
