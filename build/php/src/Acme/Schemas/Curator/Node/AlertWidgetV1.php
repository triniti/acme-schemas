...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:alert-widget:v1';
    const MIXINS = [
