...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:code-widget:v1';
    const MIXINS = [
