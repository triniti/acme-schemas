...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:category-teaser:v1';
    const MIXINS = [
