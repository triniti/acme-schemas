...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:gridler-widget:v1';
    const MIXINS = [
