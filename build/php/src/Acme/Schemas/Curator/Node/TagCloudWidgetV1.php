...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:tag-cloud-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:tag-cloud-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:tag-cloud-widget:v1';
    const MIXINS = [
