...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:person-teaser:v1';
    const MIXINS = [
