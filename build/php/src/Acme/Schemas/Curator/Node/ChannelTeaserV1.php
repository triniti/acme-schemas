...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:channel-teaser:v1';
    const MIXINS = [
