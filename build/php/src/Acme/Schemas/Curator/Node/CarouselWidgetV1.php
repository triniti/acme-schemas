...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:carousel-widget:v1';
    const MIXINS = [
