...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:media-list-widget:v1';
    const MIXINS = [
