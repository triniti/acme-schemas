...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:asset-teaser:v1';
    const MIXINS = [
