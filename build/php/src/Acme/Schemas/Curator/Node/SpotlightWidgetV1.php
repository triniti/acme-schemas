...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:spotlight-widget:v1';
    const MIXINS = [
