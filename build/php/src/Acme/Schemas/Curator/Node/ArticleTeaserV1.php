...
{
    const SCHEMA_ID = 'pbj:acme:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:node:article-teaser:v1';
    const MIXINS = [
