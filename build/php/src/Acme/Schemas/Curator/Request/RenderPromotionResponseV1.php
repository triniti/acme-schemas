...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:render-promotion-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:render-promotion-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:render-promotion-response:v1';
    const MIXINS = [
