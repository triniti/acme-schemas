...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-timeline-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-timeline-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-timeline-request:v1';
    const MIXINS = [
