...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-timelines-response:v1';
    const MIXINS = [
