...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-timelines-request:v1';
    const MIXINS = [
