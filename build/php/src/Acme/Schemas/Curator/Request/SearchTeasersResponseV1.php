...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-teasers-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-teasers-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-teasers-response:v1';
    const MIXINS = [
