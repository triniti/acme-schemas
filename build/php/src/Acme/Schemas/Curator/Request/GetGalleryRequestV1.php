...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-gallery-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-gallery-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-gallery-request:v1';
    const MIXINS = [
