...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-teaser-response:v1';
    const MIXINS = [
