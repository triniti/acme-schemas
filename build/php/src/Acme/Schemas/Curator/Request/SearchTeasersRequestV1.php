...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-teasers-request:v1';
    const MIXINS = [
