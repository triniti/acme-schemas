...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-widget-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-widget-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-widget-history-response:v1';
    const MIXINS = [
