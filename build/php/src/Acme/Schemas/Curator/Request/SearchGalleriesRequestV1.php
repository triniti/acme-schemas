...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-galleries-request:v1';
    const MIXINS = [
