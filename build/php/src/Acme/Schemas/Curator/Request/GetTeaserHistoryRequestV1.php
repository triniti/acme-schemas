...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-teaser-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-teaser-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-teaser-history-request:v1';
    const MIXINS = [
