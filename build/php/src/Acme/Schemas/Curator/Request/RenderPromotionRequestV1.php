...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:render-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:render-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:render-promotion-request:v1';
    const MIXINS = [
