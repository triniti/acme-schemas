...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:get-gallery-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:get-gallery-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:get-gallery-response:v1';
    const MIXINS = [
