...
{
    const SCHEMA_ID = 'pbj:acme:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'acme:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'acme:curator:request:search-promotions-response:v1';
    const MIXINS = [
