...
{
    const SCHEMA_ID = 'pbj:acme:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:node:archive-asset:v1';
    const MIXINS = [
