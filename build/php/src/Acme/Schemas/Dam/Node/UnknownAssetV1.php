...
{
    const SCHEMA_ID = 'pbj:acme:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:node:unknown-asset:v1';
    const MIXINS = [
