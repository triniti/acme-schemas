...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:unlink-assets:v1';
    const MIXINS = [
