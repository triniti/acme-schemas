...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:link-assets:v1';
    const MIXINS = [
