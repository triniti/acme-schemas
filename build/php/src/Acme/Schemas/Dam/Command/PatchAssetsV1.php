...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:patch-assets:v1';
    const MIXINS = [
