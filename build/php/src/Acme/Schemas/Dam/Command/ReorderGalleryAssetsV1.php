...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:reorder-gallery-assets:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:reorder-gallery-assets';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:reorder-gallery-assets:v1';
    const MIXINS = [
