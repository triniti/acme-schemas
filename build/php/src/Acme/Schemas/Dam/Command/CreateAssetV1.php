...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:create-asset:v1';
    const MIXINS = [
