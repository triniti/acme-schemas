...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:delete-asset:v1';
    const MIXINS = [
