...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:update-asset:v1';
    const MIXINS = [
