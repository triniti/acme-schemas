...
{
    const SCHEMA_ID = 'pbj:acme:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:command:expire-asset:v1';
    const MIXINS = [
