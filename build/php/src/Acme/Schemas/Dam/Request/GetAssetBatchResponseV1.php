...
use Triniti\Schemas\Dam\Mixin\GetAssetBatchResponse\GetAssetBatchResponseV1 as TrinitiDamGetAssetBatchResponseV1;
use Triniti\Schemas\Dam\Mixin\GetAssetBatchResponse\GetAssetBatchResponseV1Mixin as TrinitiDamGetAssetBatchResponseV1Mixin;

final class GetAssetBatchResponseV1 extends AbstractMessage implements
    GetAssetBatchResponse,
    GdbotsPbjxResponseV1,
    GdbotsNcrGetNodeBatchResponseV1,
    TrinitiDamGetAssetBatchResponseV1
{
    ...
    {
        return new Schema('pbj:acme:dam:request:get-asset-batch-response:1-0-0', __CLASS__,
            [],
            [
