...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:search-assets-response:v1';
    const MIXINS = [
