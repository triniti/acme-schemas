...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:get-asset-history-response:v1';
    const MIXINS = [
