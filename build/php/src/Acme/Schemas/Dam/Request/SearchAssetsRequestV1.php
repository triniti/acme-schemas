...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:search-assets-request:v1';
    const MIXINS = [
