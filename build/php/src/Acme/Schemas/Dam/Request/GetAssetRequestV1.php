...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:get-asset-request:v1';
    const MIXINS = [
