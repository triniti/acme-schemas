...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:get-asset-response:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:get-asset-response';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:get-asset-response:v1';
    const MIXINS = [
