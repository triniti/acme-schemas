...
{
    const SCHEMA_ID = 'pbj:acme:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:request:get-asset-history-request:v1';
    const MIXINS = [
