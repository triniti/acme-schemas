...
use Triniti\Schemas\Dam\Mixin\AssetUnpublished\AssetUnpublishedV1 as TrinitiDamAssetUnpublishedV1;
use Triniti\Schemas\Dam\Mixin\AssetUnpublished\AssetUnpublishedV1Mixin as TrinitiDamAssetUnpublishedV1Mixin;

final class AssetUnpublishedV1 extends AbstractMessage implements
    AssetUnpublished,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeUnpublishedV1,
    TrinitiDamAssetUnpublishedV1,
    ...
    GdbotsEnrichmentsTimeSamplingV1
{
    ...
    {
        return new Schema('pbj:acme:dam:event:asset-unpublished:1-0-0', __CLASS__,
            [],
            [
