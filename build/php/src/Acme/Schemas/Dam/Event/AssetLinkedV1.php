...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-linked:v1';
    const MIXINS = [
