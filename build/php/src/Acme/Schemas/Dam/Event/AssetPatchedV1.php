...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-patched:v1';
    const MIXINS = [
