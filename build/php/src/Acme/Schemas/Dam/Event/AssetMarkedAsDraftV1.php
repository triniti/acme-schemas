...
use Triniti\Schemas\Dam\Mixin\AssetMarkedAsDraft\AssetMarkedAsDraftV1 as TrinitiDamAssetMarkedAsDraftV1;
use Triniti\Schemas\Dam\Mixin\AssetMarkedAsDraft\AssetMarkedAsDraftV1Mixin as TrinitiDamAssetMarkedAsDraftV1Mixin;

final class AssetMarkedAsDraftV1 extends AbstractMessage implements
    AssetMarkedAsDraft,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeMarkedAsDraftV1,
    TrinitiDamAssetMarkedAsDraftV1
{
    ...
    {
        return new Schema('pbj:acme:dam:event:asset-marked-as-draft:1-0-0', __CLASS__,
            [],
            [
