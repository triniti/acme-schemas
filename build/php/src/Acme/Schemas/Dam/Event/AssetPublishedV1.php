...
use Triniti\Schemas\Dam\Mixin\AssetPublished\AssetPublishedV1 as TrinitiDamAssetPublishedV1;
use Triniti\Schemas\Dam\Mixin\AssetPublished\AssetPublishedV1Mixin as TrinitiDamAssetPublishedV1Mixin;

final class AssetPublishedV1 extends AbstractMessage implements
    AssetPublished,
    GdbotsPbjxEventV1,
    GdbotsNcrNodePublishedV1,
    TrinitiDamAssetPublishedV1,
    ...
    GdbotsEnrichmentsTimeSamplingV1
{
    ...
    {
        return new Schema('pbj:acme:dam:event:asset-published:1-0-0', __CLASS__,
            [],
            [
