...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-expired:v1';
    const MIXINS = [
