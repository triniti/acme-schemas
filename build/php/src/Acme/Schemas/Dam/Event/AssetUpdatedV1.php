...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-updated:v1';
    const MIXINS = [
