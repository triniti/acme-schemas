...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-created:v1';
    const MIXINS = [
