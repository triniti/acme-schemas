...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-unlinked:v1';
    const MIXINS = [
