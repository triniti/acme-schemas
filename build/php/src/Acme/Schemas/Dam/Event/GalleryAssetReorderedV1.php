...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
