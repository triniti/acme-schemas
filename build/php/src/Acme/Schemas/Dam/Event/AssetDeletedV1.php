...
{
    const SCHEMA_ID = 'pbj:acme:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:dam:event:asset-deleted:v1';
    const MIXINS = [
