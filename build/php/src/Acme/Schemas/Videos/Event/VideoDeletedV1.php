<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/videos/event/video-deleted/1-0-0.json#
...
use Triniti\Schemas\Videos\Mixin\VideoDeleted\VideoDeletedV1 as TrinitiVideosVideoDeletedV1;
use Triniti\Schemas\Videos\Mixin\VideoDeleted\VideoDeletedV1Mixin as TrinitiVideosVideoDeletedV1Mixin;

final class VideoDeletedV1 extends AbstractMessage implements
    VideoDeleted,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeDeletedV1,
    TrinitiVideosVideoDeletedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:videos:event:video-deleted:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeDeletedV1Mixin::create(),
                TrinitiVideosVideoDeletedV1Mixin::create(),
