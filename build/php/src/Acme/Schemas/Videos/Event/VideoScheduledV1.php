<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/videos/event/video-scheduled/1-0-0.json#
...
use Triniti\Schemas\Videos\Mixin\VideoScheduled\VideoScheduledV1 as TrinitiVideosVideoScheduledV1;
use Triniti\Schemas\Videos\Mixin\VideoScheduled\VideoScheduledV1Mixin as TrinitiVideosVideoScheduledV1Mixin;

final class VideoScheduledV1 extends AbstractMessage implements
    VideoScheduled,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeScheduledV1,
    TrinitiVideosVideoScheduledV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:videos:event:video-scheduled:1-0-0', __CLASS__,
            [],
            [
