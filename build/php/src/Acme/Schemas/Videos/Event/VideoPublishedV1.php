<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/videos/event/video-published/1-0-0.json#
...
use Triniti\Schemas\Videos\Mixin\VideoPublished\VideoPublishedV1 as TrinitiVideosVideoPublishedV1;
use Triniti\Schemas\Videos\Mixin\VideoPublished\VideoPublishedV1Mixin as TrinitiVideosVideoPublishedV1Mixin;

final class VideoPublishedV1 extends AbstractMessage implements
    VideoPublished,
    GdbotsPbjxEventV1,
    GdbotsNcrNodePublishedV1,
    TrinitiVideosVideoPublishedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:videos:event:video-published:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodePublishedV1Mixin::create(),
                TrinitiVideosVideoPublishedV1Mixin::create(),
