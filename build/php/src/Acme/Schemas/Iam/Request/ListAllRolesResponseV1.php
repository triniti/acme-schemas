...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:list-all-roles-response:v1';
    const MIXINS = [
