...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-all-apps-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-all-apps-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-all-apps-request:v1';
    const MIXINS = [
