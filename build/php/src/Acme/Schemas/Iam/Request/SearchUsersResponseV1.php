...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:search-users-response:v1';
    const MIXINS = [
