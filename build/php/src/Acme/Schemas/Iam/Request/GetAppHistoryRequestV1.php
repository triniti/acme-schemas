...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-app-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-app-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-app-history-request:v1';
    const MIXINS = [
