...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-role-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-role-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-role-history-request:v1';
    const MIXINS = [
