...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-app-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-app-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-app-request:v1';
    const MIXINS = [
