...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:list-all-roles-request:v1';
    const MIXINS = [
