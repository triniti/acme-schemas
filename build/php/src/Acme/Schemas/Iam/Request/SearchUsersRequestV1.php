...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:search-users-request:v1';
    const MIXINS = [
