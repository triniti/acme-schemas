...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-all-apps-response:v1';
    const MIXINS = [
