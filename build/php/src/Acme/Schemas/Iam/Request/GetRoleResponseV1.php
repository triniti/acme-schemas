...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-role-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-role-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-role-response:v1';
    const MIXINS = [
