...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-user-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-user-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-user-history-response:v1';
    const MIXINS = [
