...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-user-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-user-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-user-history-request:v1';
    const MIXINS = [
