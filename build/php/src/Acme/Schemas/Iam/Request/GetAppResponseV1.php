...
{
    const SCHEMA_ID = 'pbj:acme:iam:request:get-app-response:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:request:get-app-response';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:request:get-app-response:v1';
    const MIXINS = [
