...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:role-deleted:v1';
    const MIXINS = [
