...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:app-deleted:v1';
    const MIXINS = [
