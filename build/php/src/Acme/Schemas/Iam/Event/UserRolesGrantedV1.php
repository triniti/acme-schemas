...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-roles-granted:v1';
    const MIXINS = [
