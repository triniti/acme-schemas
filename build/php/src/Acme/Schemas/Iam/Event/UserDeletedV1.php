...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-deleted:v1';
    const MIXINS = [
