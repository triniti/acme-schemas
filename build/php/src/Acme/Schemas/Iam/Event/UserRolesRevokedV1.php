...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-roles-revoked:v1';
    const MIXINS = [
