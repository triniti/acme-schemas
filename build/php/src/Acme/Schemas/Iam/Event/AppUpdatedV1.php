...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:app-updated:v1';
    const MIXINS = [
