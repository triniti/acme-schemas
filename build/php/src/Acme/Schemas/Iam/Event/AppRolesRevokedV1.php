...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:app-roles-revoked:v1';
    const MIXINS = [
