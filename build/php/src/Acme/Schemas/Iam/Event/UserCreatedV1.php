...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-created:v1';
    const MIXINS = [
