...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:app-created:v1';
    const MIXINS = [
