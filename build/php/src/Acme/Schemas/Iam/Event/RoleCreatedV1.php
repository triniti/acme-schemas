...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:role-created:v1';
    const MIXINS = [
