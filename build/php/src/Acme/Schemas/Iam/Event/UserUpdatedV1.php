...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:user-updated:v1';
    const MIXINS = [
