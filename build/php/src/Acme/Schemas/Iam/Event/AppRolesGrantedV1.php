...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:app-roles-granted:v1';
    const MIXINS = [
