...
{
    const SCHEMA_ID = 'pbj:acme:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:event:role-updated:v1';
    const MIXINS = [
