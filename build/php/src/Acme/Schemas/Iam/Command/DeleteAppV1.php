...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:delete-app:v1';
    const MIXINS = [
