...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:delete-role:v1';
    const MIXINS = [
