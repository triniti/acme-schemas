...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:grant-roles-to-user:v1';
    const MIXINS = [
