...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:update-role:v1';
    const MIXINS = [
