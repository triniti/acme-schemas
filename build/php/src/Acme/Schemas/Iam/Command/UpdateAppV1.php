...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:update-app:v1';
    const MIXINS = [
