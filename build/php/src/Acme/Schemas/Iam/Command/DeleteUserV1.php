...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:delete-user:v1';
    const MIXINS = [
