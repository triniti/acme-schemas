...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:create-user:v1';
    const MIXINS = [
