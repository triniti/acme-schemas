...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:revoke-roles-from-user:v1';
    const MIXINS = [
