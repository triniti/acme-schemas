...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:grant-roles-to-app:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:grant-roles-to-app';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:grant-roles-to-app:v1';
    const MIXINS = [
