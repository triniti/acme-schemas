...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:revoke-roles-from-app:v1';
    const MIXINS = [
