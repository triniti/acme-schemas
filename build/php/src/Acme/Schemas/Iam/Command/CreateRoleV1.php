...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:create-role:v1';
    const MIXINS = [
