...
final class PatchUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:acme:iam:command:patch-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:patch-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:patch-user:v1';
    const MIXINS = [
