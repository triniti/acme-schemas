...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:create-app:v1';
    const MIXINS = [
