...
{
    const SCHEMA_ID = 'pbj:acme:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'acme:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'acme:iam:command:update-user:v1';
    const MIXINS = [
