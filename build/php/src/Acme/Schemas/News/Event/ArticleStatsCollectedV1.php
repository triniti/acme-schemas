...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-stats-collected:v1';
    const MIXINS = [
