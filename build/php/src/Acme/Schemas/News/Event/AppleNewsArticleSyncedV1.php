...
{
    const SCHEMA_ID = 'pbj:acme:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:apple-news-article-synced:v1';
    const MIXINS = [
