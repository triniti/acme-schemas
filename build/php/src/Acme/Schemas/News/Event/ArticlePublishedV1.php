...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-published:v1';
    const MIXINS = [
