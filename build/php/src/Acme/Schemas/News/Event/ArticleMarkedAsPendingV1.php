...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-marked-as-pending:v1';
    const MIXINS = [
