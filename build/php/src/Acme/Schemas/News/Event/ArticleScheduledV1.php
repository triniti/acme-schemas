...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-scheduled:v1';
    const MIXINS = [
