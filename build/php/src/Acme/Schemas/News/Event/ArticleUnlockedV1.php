...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-unlocked:v1';
    const MIXINS = [
