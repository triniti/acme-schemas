...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-marked-as-draft:v1';
    const MIXINS = [
