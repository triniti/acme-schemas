...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-renamed:v1';
    const MIXINS = [
