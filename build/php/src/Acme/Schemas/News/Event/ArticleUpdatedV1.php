...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-updated:v1';
    const MIXINS = [
