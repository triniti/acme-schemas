...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-locked:v1';
    const MIXINS = [
