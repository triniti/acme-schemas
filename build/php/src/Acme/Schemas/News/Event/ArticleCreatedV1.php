...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-created:v1';
    const MIXINS = [
