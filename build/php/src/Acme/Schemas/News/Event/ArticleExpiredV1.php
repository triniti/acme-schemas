...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-expired:v1';
    const MIXINS = [
