...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-deleted:v1';
    const MIXINS = [
