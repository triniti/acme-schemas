...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-unpublished:v1';
    const MIXINS = [
