...
{
    const SCHEMA_ID = 'pbj:acme:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'acme:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'acme:news:event:article-slotting-removed:v1';
    const MIXINS = [
