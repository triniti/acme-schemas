...
// @link http://acme-schemas.triniti.io/json-schema/acme/news/node/article/1-0-3.json#
...
{
    const SCHEMA_ID = 'pbj:acme:news:node:article:1-0-3';
    const SCHEMA_CURIE = 'acme:news:node:article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:node:article:v1';
    const MIXINS = [
