...
{
    const SCHEMA_ID = 'pbj:acme:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'acme:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'acme:news:node:article-stats:v1';
    const MIXINS = [
