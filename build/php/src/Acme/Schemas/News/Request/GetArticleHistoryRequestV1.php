...
{
    const SCHEMA_ID = 'pbj:acme:news:request:get-article-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:news:request:get-article-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:news:request:get-article-history-request:v1';
    const MIXINS = [
