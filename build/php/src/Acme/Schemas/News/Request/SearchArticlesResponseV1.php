...
{
    const SCHEMA_ID = 'pbj:acme:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'acme:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'acme:news:request:search-articles-response:v1';
    const MIXINS = [
