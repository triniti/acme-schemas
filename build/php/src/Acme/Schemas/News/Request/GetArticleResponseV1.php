...
{
    const SCHEMA_ID = 'pbj:acme:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'acme:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'acme:news:request:get-article-response:v1';
    const MIXINS = [
