...
{
    const SCHEMA_ID = 'pbj:acme:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'acme:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'acme:news:request:get-article-request:v1';
    const MIXINS = [
