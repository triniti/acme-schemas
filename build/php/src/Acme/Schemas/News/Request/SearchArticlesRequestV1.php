...
{
    const SCHEMA_ID = 'pbj:acme:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'acme:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'acme:news:request:search-articles-request:v1';
    const MIXINS = [
