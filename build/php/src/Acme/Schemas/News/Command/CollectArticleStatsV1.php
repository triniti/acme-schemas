...
{
    const SCHEMA_ID = 'pbj:acme:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:collect-article-stats:v1';
    const MIXINS = [
