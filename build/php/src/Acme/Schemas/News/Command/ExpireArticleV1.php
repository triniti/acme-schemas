...
{
    const SCHEMA_ID = 'pbj:acme:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:expire-article:v1';
    const MIXINS = [
