...
{
    const SCHEMA_ID = 'pbj:acme:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:update-article:v1';
    const MIXINS = [
