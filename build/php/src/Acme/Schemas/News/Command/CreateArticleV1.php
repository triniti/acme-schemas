...
{
    const SCHEMA_ID = 'pbj:acme:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:create-article:v1';
    const MIXINS = [
