...
{
    const SCHEMA_ID = 'pbj:acme:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:rename-article:v1';
    const MIXINS = [
