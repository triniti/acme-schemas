...
{
    const SCHEMA_ID = 'pbj:acme:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:mark-article-as-draft:v1';
    const MIXINS = [
