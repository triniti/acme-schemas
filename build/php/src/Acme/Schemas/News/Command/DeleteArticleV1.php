...
{
    const SCHEMA_ID = 'pbj:acme:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:delete-article:v1';
    const MIXINS = [
