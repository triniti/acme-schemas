...
{
    const SCHEMA_ID = 'pbj:acme:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:unpublish-article:v1';
    const MIXINS = [
