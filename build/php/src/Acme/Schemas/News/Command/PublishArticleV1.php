...
{
    const SCHEMA_ID = 'pbj:acme:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:publish-article:v1';
    const MIXINS = [
