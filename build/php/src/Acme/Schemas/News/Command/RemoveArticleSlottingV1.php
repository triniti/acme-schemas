...
{
    const SCHEMA_ID = 'pbj:acme:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:remove-article-slotting:v1';
    const MIXINS = [
