...
{
    const SCHEMA_ID = 'pbj:acme:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:unlock-article:v1';
    const MIXINS = [
