...
{
    const SCHEMA_ID = 'pbj:acme:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:lock-article:v1';
    const MIXINS = [
