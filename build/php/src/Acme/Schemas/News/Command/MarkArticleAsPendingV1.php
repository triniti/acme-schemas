...
{
    const SCHEMA_ID = 'pbj:acme:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:news:command:mark-article-as-pending:v1';
    const MIXINS = [
