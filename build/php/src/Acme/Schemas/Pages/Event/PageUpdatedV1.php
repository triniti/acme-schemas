<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-updated/1-0-0.json#
...
use Triniti\Schemas\Pages\Mixin\PageUpdated\PageUpdatedV1 as TrinitiPagesPageUpdatedV1;
use Triniti\Schemas\Pages\Mixin\PageUpdated\PageUpdatedV1Mixin as TrinitiPagesPageUpdatedV1Mixin;

final class PageUpdatedV1 extends AbstractMessage implements
    PageUpdated,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeUpdatedV1,
    TrinitiPagesPageUpdatedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-updated:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeUpdatedV1Mixin::create(),
                TrinitiPagesPageUpdatedV1Mixin::create(),
