<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-deleted/1-0-0.json#
...
use Triniti\Schemas\Pages\Mixin\PageDeleted\PageDeletedV1 as TrinitiPagesPageDeletedV1;
use Triniti\Schemas\Pages\Mixin\PageDeleted\PageDeletedV1Mixin as TrinitiPagesPageDeletedV1Mixin;

final class PageDeletedV1 extends AbstractMessage implements
    PageDeleted,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeDeletedV1,
    TrinitiPagesPageDeletedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-deleted:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeDeletedV1Mixin::create(),
                TrinitiPagesPageDeletedV1Mixin::create(),
