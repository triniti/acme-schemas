<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-unpublished/1-0-0.json#
namespace Acme\Schemas\Pages\Event;
...
use Triniti\Schemas\Pages\Mixin\PageUnpublished\PageUnpublishedV1 as TrinitiPagesPageUnpublishedV1;
use Triniti\Schemas\Pages\Mixin\PageUnpublished\PageUnpublishedV1Mixin as TrinitiPagesPageUnpublishedV1Mixin;

final class PageUnpublishedV1 extends AbstractMessage implements
    PageUnpublished,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeUnpublishedV1,
    TrinitiPagesPageUnpublishedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-unpublished:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeUnpublishedV1Mixin::create(),
                TrinitiPagesPageUnpublishedV1Mixin::create(),
