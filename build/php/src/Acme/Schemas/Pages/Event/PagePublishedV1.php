<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-published/1-0-0.json#
...
use Triniti\Schemas\Pages\Mixin\PagePublished\PagePublishedV1 as TrinitiPagesPagePublishedV1;
use Triniti\Schemas\Pages\Mixin\PagePublished\PagePublishedV1Mixin as TrinitiPagesPagePublishedV1Mixin;

final class PagePublishedV1 extends AbstractMessage implements
    PagePublished,
    GdbotsPbjxEventV1,
    GdbotsNcrNodePublishedV1,
    TrinitiPagesPagePublishedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-published:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodePublishedV1Mixin::create(),
                TrinitiPagesPagePublishedV1Mixin::create(),
