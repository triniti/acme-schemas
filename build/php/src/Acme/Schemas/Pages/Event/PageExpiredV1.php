<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-expired/1-0-0.json#
...
use Triniti\Schemas\Pages\Mixin\PageExpired\PageExpiredV1 as TrinitiPagesPageExpiredV1;
use Triniti\Schemas\Pages\Mixin\PageExpired\PageExpiredV1Mixin as TrinitiPagesPageExpiredV1Mixin;

final class PageExpiredV1 extends AbstractMessage implements
    PageExpired,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeExpiredV1,
    TrinitiPagesPageExpiredV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-expired:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeExpiredV1Mixin::create(),
                TrinitiPagesPageExpiredV1Mixin::create(),
