<?php
// @link http://acme-schemas.gdbots.io/json-schema/acme/pages/event/page-created/1-0-0.json#
...
use Triniti\Schemas\Pages\Mixin\PageCreated\PageCreatedV1 as TrinitiPagesPageCreatedV1;
use Triniti\Schemas\Pages\Mixin\PageCreated\PageCreatedV1Mixin as TrinitiPagesPageCreatedV1Mixin;

final class PageCreatedV1 extends AbstractMessage implements
    PageCreated,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeCreatedV1,
    TrinitiPagesPageCreatedV1,
    ...
    GdbotsEnrichmentsUaParserV1
{
    ...
    {
        return new Schema('pbj:acme:pages:event:page-created:1-0-0', __CLASS__,
            [],
            [
                GdbotsPbjxEventV1Mixin::create(),
                GdbotsNcrNodeCreatedV1Mixin::create(),
                TrinitiPagesPageCreatedV1Mixin::create(),
