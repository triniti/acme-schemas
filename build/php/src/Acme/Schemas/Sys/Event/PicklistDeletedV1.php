...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:picklist-deleted:v1';
    const MIXINS = [
