...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:redirect-created:v1';
    const MIXINS = [
