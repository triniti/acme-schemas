...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:picklist-updated:v1';
    const MIXINS = [
