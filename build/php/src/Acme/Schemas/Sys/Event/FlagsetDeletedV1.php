...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:flagset-deleted:v1';
    const MIXINS = [
