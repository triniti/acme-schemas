...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:redirect-updated:v1';
    const MIXINS = [
