...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:picklist-created:v1';
    const MIXINS = [
