...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:flagset-updated:v1';
    const MIXINS = [
