...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:flagset-created:v1';
    const MIXINS = [
