...
namespace Acme\Schemas\Sys\Event;
...
{
    const SCHEMA_ID = 'pbj:acme:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:event:redirect-deleted:v1';
    const MIXINS = [
