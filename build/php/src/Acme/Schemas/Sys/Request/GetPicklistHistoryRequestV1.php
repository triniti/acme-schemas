...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-picklist-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-picklist-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-picklist-history-request:v1';
    const MIXINS = [
