...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:search-redirects-request:v1';
    const MIXINS = [
