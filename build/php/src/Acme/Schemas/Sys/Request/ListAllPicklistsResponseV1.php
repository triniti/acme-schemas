...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:list-all-picklists-response:v1';
    const MIXINS = [
