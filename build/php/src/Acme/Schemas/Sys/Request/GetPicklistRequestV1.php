...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-picklist-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-picklist-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-picklist-request:v1';
    const MIXINS = [
