...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-flagset-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-flagset-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-flagset-history-request:v1';
    const MIXINS = [
