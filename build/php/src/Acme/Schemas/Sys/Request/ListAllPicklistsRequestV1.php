...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:list-all-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:list-all-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:list-all-picklists-request:v1';
    const MIXINS = [
