...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:list-all-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:list-all-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:list-all-flagsets-request:v1';
    const MIXINS = [
