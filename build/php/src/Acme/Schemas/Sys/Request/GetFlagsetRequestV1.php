...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-flagset-request:v1';
    const MIXINS = [
