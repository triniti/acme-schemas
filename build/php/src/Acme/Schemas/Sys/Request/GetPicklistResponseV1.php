...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-picklist-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-picklist-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-picklist-response:v1';
    const MIXINS = [
