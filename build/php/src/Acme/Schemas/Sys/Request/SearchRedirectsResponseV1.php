...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:search-redirects-response:v1';
    const MIXINS = [
