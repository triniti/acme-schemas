...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-redirect-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-redirect-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-redirect-response:v1';
    const MIXINS = [
