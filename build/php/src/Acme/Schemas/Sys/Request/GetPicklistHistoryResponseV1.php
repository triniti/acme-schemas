...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:get-picklist-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:get-picklist-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:get-picklist-history-response:v1';
    const MIXINS = [
