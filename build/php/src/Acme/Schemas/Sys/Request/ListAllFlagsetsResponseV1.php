...
{
    const SCHEMA_ID = 'pbj:acme:sys:request:list-all-flagsets-response:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:request:list-all-flagsets-response';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:request:list-all-flagsets-response:v1';
    const MIXINS = [
