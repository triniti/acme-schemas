...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:create-redirect:v1';
    const MIXINS = [
