...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:update-redirect:v1';
    const MIXINS = [
