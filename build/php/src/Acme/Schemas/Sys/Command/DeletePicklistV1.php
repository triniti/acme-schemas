...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:delete-picklist:v1';
    const MIXINS = [
