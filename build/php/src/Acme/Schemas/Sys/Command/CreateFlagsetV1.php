...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:create-flagset:v1';
    const MIXINS = [
