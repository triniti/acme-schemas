...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:delete-flagset:v1';
    const MIXINS = [
