...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:delete-redirect:v1';
    const MIXINS = [
