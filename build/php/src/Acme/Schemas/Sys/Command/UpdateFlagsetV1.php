...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:update-flagset:v1';
    const MIXINS = [
