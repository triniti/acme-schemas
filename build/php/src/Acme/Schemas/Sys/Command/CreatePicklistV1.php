...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:create-picklist:v1';
    const MIXINS = [
