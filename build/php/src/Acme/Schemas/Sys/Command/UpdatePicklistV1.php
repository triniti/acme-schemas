...
{
    const SCHEMA_ID = 'pbj:acme:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'acme:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'acme:sys:command:update-picklist:v1';
    const MIXINS = [
