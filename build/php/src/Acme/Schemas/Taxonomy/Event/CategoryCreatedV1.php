...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:category-created:v1';
    const MIXINS = [
