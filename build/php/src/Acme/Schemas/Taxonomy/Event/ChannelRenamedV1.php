...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:channel-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:channel-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:channel-renamed:v1';
    const MIXINS = [
