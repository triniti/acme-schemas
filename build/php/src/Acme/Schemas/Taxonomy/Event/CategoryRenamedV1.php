...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:category-renamed:v1';
    const MIXINS = [
