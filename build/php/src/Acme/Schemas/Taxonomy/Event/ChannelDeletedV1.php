...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:channel-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:channel-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:channel-deleted:v1';
    const MIXINS = [
