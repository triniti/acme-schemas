...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:channel-updated:v1';
    const MIXINS = [
