...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:event:category-deleted:v1';
    const MIXINS = [
