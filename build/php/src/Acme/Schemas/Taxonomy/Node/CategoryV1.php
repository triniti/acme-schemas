...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:node:category:v1';
    const MIXINS = [
