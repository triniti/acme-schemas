...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:node:channel:v1';
    const MIXINS = [
