...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:rename-channel:v1';
    const MIXINS = [
