...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:update-category:v1';
    const MIXINS = [
