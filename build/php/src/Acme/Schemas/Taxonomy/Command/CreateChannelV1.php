...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:create-channel:v1';
    const MIXINS = [
