...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:create-category:v1';
    const MIXINS = [
