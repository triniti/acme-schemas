...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:rename-category:v1';
    const MIXINS = [
