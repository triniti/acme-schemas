...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:delete-channel:v1';
    const MIXINS = [
