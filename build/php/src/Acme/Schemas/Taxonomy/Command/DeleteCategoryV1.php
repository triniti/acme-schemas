...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:delete-category:v1';
    const MIXINS = [
