...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:command:update-channel:v1';
    const MIXINS = [
