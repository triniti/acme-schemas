...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:suggest-hashtags-request:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:suggest-hashtags-request';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:suggest-hashtags-request:v1';
    const MIXINS = [
