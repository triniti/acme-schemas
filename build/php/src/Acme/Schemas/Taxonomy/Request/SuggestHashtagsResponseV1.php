...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:suggest-hashtags-response:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:suggest-hashtags-response';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:suggest-hashtags-response:v1';
    const MIXINS = [
