...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:get-category-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:get-category-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:get-category-history-response:v1';
    const MIXINS = [
