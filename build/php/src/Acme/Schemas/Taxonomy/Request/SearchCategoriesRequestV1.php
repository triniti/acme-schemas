...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:search-categories-request:v1';
    const MIXINS = [
