...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:get-category-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:get-category-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:get-category-history-request:v1';
    const MIXINS = [
