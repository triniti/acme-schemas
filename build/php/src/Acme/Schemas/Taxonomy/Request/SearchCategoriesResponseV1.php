...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:search-categories-response:v1';
    const MIXINS = [
