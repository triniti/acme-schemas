...
use Triniti\Schemas\Taxonomy\Mixin\GetCategoryRequest\GetCategoryRequestV1 as TrinitiTaxonomyGetCategoryRequestV1;
use Triniti\Schemas\Taxonomy\Mixin\GetCategoryRequest\GetCategoryRequestV1Mixin as TrinitiTaxonomyGetCategoryRequestV1Mixin;

final class GetCategoryRequestV1 extends AbstractMessage implements
    GetCategoryRequest,
    GdbotsPbjxRequestV1,
    GdbotsNcrGetNodeRequestV1,
    TrinitiTaxonomyGetCategoryRequestV1
{
    ...
    {
        return new Schema('pbj:acme:taxonomy:request:get-category-request:1-0-0', __CLASS__,
            [],
            [
