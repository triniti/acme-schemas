...
{
    const SCHEMA_ID = 'pbj:acme:taxonomy:request:get-channel-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:taxonomy:request:get-channel-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:taxonomy:request:get-channel-history-request:v1';
    const MIXINS = [
