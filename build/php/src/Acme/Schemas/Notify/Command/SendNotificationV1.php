...
{
    const SCHEMA_ID = 'pbj:acme:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:command:send-notification:v1';
    const MIXINS = [
