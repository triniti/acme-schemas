...
{
    const SCHEMA_ID = 'pbj:acme:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:command:delete-notification:v1';
    const MIXINS = [
