...
{
    const SCHEMA_ID = 'pbj:acme:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:command:create-notification:v1';
    const MIXINS = [
