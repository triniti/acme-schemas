...
namespace Acme\Schemas\Notify\Command;
...
{
    const SCHEMA_ID = 'pbj:acme:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:command:update-notification:v1';
    const MIXINS = [
