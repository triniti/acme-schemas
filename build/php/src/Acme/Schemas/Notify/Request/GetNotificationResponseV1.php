...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:get-notification-response:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:get-notification-response';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:get-notification-response:v1';
    const MIXINS = [
