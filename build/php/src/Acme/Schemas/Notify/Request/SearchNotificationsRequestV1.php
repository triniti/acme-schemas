...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:search-notifications-request:v1';
    const MIXINS = [
