...
namespace Acme\Schemas\Notify\Request;
...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:get-notification-history-response:v1';
    const MIXINS = [
