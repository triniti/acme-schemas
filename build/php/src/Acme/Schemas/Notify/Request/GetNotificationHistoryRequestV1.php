...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:get-notification-history-request:v1';
    const MIXINS = [
