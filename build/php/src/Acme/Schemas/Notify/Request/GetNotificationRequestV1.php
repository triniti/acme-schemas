...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:get-notification-request:v1';
    const MIXINS = [
