...
{
    const SCHEMA_ID = 'pbj:acme:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:request:search-notifications-response:v1';
    const MIXINS = [
