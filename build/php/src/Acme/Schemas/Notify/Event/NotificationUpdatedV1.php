...
{
    const SCHEMA_ID = 'pbj:acme:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-updated:v1';
    const MIXINS = [
