...
{
    const SCHEMA_ID = 'pbj:acme:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-sent:v1';
    const MIXINS = [
