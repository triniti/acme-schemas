...
{
    const SCHEMA_ID = 'pbj:acme:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-failed:v1';
    const MIXINS = [
