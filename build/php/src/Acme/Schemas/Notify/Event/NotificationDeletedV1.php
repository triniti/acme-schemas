...
{
    const SCHEMA_ID = 'pbj:acme:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-deleted:v1';
    const MIXINS = [
