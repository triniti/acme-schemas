...
{
    const SCHEMA_ID = 'pbj:acme:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:event:notification-created:v1';
    const MIXINS = [
