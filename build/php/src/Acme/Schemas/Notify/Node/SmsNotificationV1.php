...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:sms-notification:v1';
    const MIXINS = [
