...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:twitter-notification:v1';
    const MIXINS = [
