...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:browser-notification:v1';
    const MIXINS = [
