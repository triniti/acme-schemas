...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:ios-notification:v1';
    const MIXINS = [
