...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:alexa-notification:v1';
    const MIXINS = [
