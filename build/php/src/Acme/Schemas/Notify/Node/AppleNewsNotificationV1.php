...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:apple-news-notification:v1';
    const MIXINS = [
