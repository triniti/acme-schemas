...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:slack-notification:v1';
    const MIXINS = [
