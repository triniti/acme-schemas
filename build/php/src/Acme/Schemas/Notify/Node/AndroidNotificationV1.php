...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:android-notification:v1';
    const MIXINS = [
