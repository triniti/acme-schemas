...
{
    const SCHEMA_ID = 'pbj:acme:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'acme:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'acme:notify:node:email-notification:v1';
    const MIXINS = [
