...
{
    const SCHEMA_ID = 'pbj:acme:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:people:event:person-updated:v1';
    const MIXINS = [
