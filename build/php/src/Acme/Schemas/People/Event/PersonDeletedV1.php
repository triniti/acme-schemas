...
{
    const SCHEMA_ID = 'pbj:acme:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:people:event:person-deleted:v1';
    const MIXINS = [
