...
{
    const SCHEMA_ID = 'pbj:acme:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:people:event:person-renamed:v1';
    const MIXINS = [
