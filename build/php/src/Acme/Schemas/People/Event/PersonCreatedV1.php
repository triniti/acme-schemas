...
{
    const SCHEMA_ID = 'pbj:acme:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'acme:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'acme:people:event:person-created:v1';
    const MIXINS = [
