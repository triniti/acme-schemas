...
{
    const SCHEMA_ID = 'pbj:acme:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'acme:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'acme:people:command:rename-person:v1';
    const MIXINS = [
