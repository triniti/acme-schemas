...
{
    const SCHEMA_ID = 'pbj:acme:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'acme:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'acme:people:command:update-person:v1';
    const MIXINS = [
