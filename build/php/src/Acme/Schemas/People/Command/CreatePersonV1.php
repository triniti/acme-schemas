...
{
    const SCHEMA_ID = 'pbj:acme:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'acme:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'acme:people:command:create-person:v1';
    const MIXINS = [
