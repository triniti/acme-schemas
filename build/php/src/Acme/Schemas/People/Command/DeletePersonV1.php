...
{
    const SCHEMA_ID = 'pbj:acme:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'acme:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'acme:people:command:delete-person:v1';
    const MIXINS = [
