...
{
    const SCHEMA_ID = 'pbj:acme:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:people:request:get-person-history-response:v1';
    const MIXINS = [
