...
{
    const SCHEMA_ID = 'pbj:acme:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'acme:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'acme:people:request:search-people-request:v1';
    const MIXINS = [
