...
{
    const SCHEMA_ID = 'pbj:acme:people:request:get-person-request:1-0-0';
    const SCHEMA_CURIE = 'acme:people:request:get-person-request';
    const SCHEMA_CURIE_MAJOR = 'acme:people:request:get-person-request:v1';
    const MIXINS = [
