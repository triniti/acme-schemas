...
{
    const SCHEMA_ID = 'pbj:acme:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'acme:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'acme:people:request:search-people-response:v1';
    const MIXINS = [
