...
{
    const SCHEMA_ID = 'pbj:acme:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'acme:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'acme:people:request:get-person-response:v1';
    const MIXINS = [
