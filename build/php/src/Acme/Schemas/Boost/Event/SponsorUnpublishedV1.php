...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-unpublished:v1';
    const MIXINS = [
