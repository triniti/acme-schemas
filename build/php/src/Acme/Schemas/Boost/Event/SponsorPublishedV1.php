...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-published:v1';
    const MIXINS = [
