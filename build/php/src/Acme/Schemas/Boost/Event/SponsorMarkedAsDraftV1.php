...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-marked-as-draft:v1';
    const MIXINS = [
