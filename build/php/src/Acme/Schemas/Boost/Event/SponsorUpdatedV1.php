...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-updated:v1';
    const MIXINS = [
