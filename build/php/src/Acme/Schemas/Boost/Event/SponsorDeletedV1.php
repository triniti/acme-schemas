...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-deleted:v1';
    const MIXINS = [
