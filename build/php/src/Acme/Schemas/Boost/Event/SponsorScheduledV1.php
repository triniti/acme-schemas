...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-scheduled:v1';
    const MIXINS = [
