...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-renamed:v1';
    const MIXINS = [
