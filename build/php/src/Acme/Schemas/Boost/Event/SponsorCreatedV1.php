...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-created:v1';
    const MIXINS = [
