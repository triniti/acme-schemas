...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-expired:v1';
    const MIXINS = [
