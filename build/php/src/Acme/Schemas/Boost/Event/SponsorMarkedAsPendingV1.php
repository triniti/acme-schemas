...
namespace Acme\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:acme:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [
