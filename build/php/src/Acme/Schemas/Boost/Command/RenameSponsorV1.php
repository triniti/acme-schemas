...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:rename-sponsor:v1';
    const MIXINS = [
