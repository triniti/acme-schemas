...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:unpublish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:unpublish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:unpublish-sponsor:v1';
    const MIXINS = [
