...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:mark-sponsor-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:mark-sponsor-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:mark-sponsor-as-draft:v1';
    const MIXINS = [
