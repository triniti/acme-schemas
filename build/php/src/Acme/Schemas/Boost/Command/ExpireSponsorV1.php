...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:expire-sponsor:v1';
    const MIXINS = [
