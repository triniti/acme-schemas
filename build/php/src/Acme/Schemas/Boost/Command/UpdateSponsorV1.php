...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:update-sponsor:v1';
    const MIXINS = [
