...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:create-sponsor:v1';
    const MIXINS = [
