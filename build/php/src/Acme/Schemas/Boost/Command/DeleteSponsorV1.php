...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:delete-sponsor:v1';
    const MIXINS = [
