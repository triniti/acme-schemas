...
namespace Acme\Schemas\Boost\Command;
...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:mark-sponsor-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:mark-sponsor-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:mark-sponsor-as-pending:v1';
    const MIXINS = [
