...
{
    const SCHEMA_ID = 'pbj:acme:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:command:publish-sponsor:v1';
    const MIXINS = [
