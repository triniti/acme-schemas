...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:search-sponsors-response:v1';
    const MIXINS = [
