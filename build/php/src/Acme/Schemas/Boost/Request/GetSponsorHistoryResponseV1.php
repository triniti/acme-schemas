...
namespace Acme\Schemas\Boost\Request;
...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:get-sponsor-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:get-sponsor-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:get-sponsor-history-response:v1';
    const MIXINS = [
