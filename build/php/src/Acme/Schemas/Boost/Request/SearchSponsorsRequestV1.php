...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:search-sponsors-request:v1';
    const MIXINS = [
