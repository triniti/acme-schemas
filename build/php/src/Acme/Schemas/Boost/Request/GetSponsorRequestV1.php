...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:get-sponsor-request:v1';
    const MIXINS = [
