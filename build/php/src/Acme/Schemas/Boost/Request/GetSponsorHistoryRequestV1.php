...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:get-sponsor-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:get-sponsor-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:get-sponsor-history-request:v1';
    const MIXINS = [
