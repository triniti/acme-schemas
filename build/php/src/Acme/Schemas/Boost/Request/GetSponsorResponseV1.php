...
{
    const SCHEMA_ID = 'pbj:acme:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'acme:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'acme:boost:request:get-sponsor-response:v1';
    const MIXINS = [
