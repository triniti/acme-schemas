...
{
    const SCHEMA_ID = 'pbj:acme:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:request:get-video-request:v1';
    const MIXINS = [
