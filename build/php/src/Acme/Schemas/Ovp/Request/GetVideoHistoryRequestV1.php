...
{
    const SCHEMA_ID = 'pbj:acme:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:request:get-video-history-request:v1';
    const MIXINS = [
