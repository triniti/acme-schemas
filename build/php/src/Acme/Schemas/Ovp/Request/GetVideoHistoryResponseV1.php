...
{
    const SCHEMA_ID = 'pbj:acme:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:request:get-video-history-response:v1';
    const MIXINS = [
