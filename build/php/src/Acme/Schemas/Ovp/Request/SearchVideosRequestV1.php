...
{
    const SCHEMA_ID = 'pbj:acme:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:request:search-videos-request:v1';
    const MIXINS = [
