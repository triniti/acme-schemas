...
{
    const SCHEMA_ID = 'pbj:acme:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:request:search-videos-response:v1';
    const MIXINS = [
