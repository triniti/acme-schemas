...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:expire-video:v1';
    const MIXINS = [
