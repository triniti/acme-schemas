...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:rename-video:v1';
    const MIXINS = [
