...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:mark-video-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:mark-video-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:mark-video-as-draft:v1';
    const MIXINS = [
