...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:publish-video:v1';
    const MIXINS = [
