...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [
