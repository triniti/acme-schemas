...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:delete-video:v1';
    const MIXINS = [
