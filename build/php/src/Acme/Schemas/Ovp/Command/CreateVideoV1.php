...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:create-video:v1';
    const MIXINS = [
