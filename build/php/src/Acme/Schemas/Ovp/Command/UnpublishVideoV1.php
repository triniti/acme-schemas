...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:unpublish-video:v1';
    const MIXINS = [
