...
{
    const SCHEMA_ID = 'pbj:acme:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:command:update-video:v1';
    const MIXINS = [
