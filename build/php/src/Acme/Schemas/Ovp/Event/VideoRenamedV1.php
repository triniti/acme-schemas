...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-renamed:v1';
    const MIXINS = [
