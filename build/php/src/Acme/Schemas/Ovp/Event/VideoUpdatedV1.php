...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-updated:v1';
    const MIXINS = [
