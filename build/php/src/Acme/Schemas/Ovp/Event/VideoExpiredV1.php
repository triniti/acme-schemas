...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-expired:v1';
    const MIXINS = [
