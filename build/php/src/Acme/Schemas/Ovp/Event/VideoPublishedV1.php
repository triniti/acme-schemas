...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-published:v1';
    const MIXINS = [
