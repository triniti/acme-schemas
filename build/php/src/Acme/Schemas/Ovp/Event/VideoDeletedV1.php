...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-deleted:v1';
    const MIXINS = [
