...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-marked-as-pending:v1';
    const MIXINS = [
