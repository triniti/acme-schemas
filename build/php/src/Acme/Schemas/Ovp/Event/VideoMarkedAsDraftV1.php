...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-marked-as-draft:v1';
    const MIXINS = [
