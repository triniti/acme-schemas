...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-scheduled:v1';
    const MIXINS = [
