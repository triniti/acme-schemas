...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-unpublished:v1';
    const MIXINS = [
