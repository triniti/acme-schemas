...
{
    const SCHEMA_ID = 'pbj:acme:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'acme:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'acme:ovp:event:video-created:v1';
    const MIXINS = [
